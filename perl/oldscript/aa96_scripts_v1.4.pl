...
for ($scriptType) {
	/^0$/ && do {&writeTemplateToMScript("${scriptDir}/${projName}_idaFit.m", "${templateDir}/idaFit.template", $paramFile);
					...
					&writeCleanUpScript("${scriptDir}/${projName}_cleanUpIda.bat"); last;};
	...
	/^8$/ && do {&writeAvgScript("${scriptDir}/${projName}_avgIdaV1.bat" , $listFile, $paramFile); last;}; 
	/^9$/ && do {&writeTemplateToMScript("${scriptDir}/${projName}_calcMwWeightIdaV1.m", "${templateDir}/calcMwWeight.template" , $paramFile); last;};
	/^10$/ && do {&writeTemplateToMScript("${scriptDir}/${projName}_weightedAvgIdaV1.m", "${templateDir}/weightedAvg.template" , $paramFile); last;};
	/^11$/ && do {&writeCleanUpScript("${scriptDir}/${projName}_cleanUpIda.bat"); last;};
	/^12$/ && do {
...
sub writeIdaScript {
	...
	print FILEHDL "nohup batch_job_submit.pl $numberOfProcessors ./$scriptDir/${projName}_intraAlnIdaV1.bat > intraAlnIdaV1.log\n";
	print FILEHDL "nohup batch_job_submit.pl $numberOfProcessors ./$scriptDir/${projName}_intraAlnIdaV2.bat > intraAlnIdaV2.log\n";
	print FILEHDL "nohup batch_job_submit.pl $numberOfProcessors ./$scriptDir/${projName}_intraAlnIdaV3.bat > intraAlnIdaV3.log\n";
	print FILEHDL "nohup batch_job_submit.pl $numberOfProcessors ./$scriptDir/${projName}_intraAlnIdaV4.bat > intraAlnIdaV4.log\n";
	print FILEHDL "./$scriptDir/${projName}_shiftIdaAln.bat > shiftIdaAln.log\n";
	print FILEHDL "./$scriptDir/${projName}_pickIda.bat\n";
	print FILEHDL "./$scriptDir/${projName}_cbnDocIdaV1.bat > cbnDocIdaV1.log\n";
	print FILEHDL "nohup batch_job_submit.pl $numberOfProcessors ./$scriptDir/${projName}_interAlnIdaV1.bat > interAlnIdaV1.log\n";
	print FILEHDL "./$scriptDir/${projName}_cbnAllDocIdaV1.bat > cbnAllDocIdaV1.log\n";
	print FILEHDL "./$scriptDir/${projName}_avgIdaV1.bat > avgIdaV1.log\n";
	print FILEHDL "./$scriptDir/${projName}_calcMwWeightIdaV1.bat > calcMwWeightIdaV1.log\n";
	print FILEHDL "./$scriptDir/${projName}_weightedAvgIdaV1.bat > weightedAvgIdaV1.log\n";
