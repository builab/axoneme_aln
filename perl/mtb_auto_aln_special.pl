...
# DO NOT DELETE PARTICLES IN AVERAGING
use Cwd;
use Data::Dumper;

$scriptName = "MTB_AUTO_ALN_SPECIAL.PL";
$version = '1.91s';
$vdate = '2011/09/25';
...
# Associated script
$spider_aln_script = 'spider_aln_special.pl';
...
$iter = 1;
$searchType = 0;
$processingDir = getcwd; # TO CHANGE OR PUT INTO COMMAND LINE OPTION
$startingDir = getcwd;
...
#		system($mvCmd);
#	}
#	print("mv ${tmp_dir}/${doc_prefix_tmp}${output}.spi ${startingDir}/doc\n");
#	system("mv ${tmp_dir}/${doc_prefix_tmp}${output}.spi ${startingDir}/doc");
	chdir $startingDir;
#	system($rmCmd);
}
