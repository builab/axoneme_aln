...
%   matrix, return the vector transformed with affine transform TRANS.
%
...
%                            [0 0 1]
%
%   VECT2 = transformVector(VECT1, TRANS) also wotk when PTA is a [N*2]
%   array of double. In this case, VECT2 has the same size as VECT1.
%
%   [vx2 vy2] = transformVector(vx1, vy1, TRANS) 
%   Also work when vx1 and vy1 are arrays the same size. The function
%   transform each couple of (vx1, vy1), and return the result in 
%   (vx2, vy2), which is the same size as (vx1 vy1).
%
%
%   See also :
%   translation, rotation, transformPoint
%
%   ---------
%
