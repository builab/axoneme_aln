function varargout = drawPolyhedron(varargin)
%DRAWPOLYHEDRON draw polyhedron defined by vertices and faces
%
%   drawPolyhedron(NODES, FACES)
%   Draw the polyhedron defined by vertices NODES and the faces FACES. 
...
%   number of vertices.
%   
%   H = drawPolyhedron(...) also return handles to the created patches.
%
%   Example:
...
if length(varargin)<=2
    ...
    error ('wrong number of arguments in "drawPolyhedron"');
end
