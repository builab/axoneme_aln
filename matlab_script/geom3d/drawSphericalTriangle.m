...
p1 = normalize3d(p1-ori);
p2 = normalize3d(p2-ori);
p3 = normalize3d(p3-ori);
...
pp2 = planePosition(intersectPlaneLine(plane, [ori p2]), plane);
pp3 = planePosition(intersectPlaneLine(plane, [ori p3]), plane);
