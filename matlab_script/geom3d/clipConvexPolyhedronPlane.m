function [nodes2 faces2] = clipConvexPolyhedronPlane(nodes, faces, plane)
%CLIPCONVEXPOLYHEDRONPLANE clip a convex polyhedron by a plane
%
%   [NODES2, FACES2] = clipConvexPolyhedraPlane(NODES, FACES, PLANE)
%
...
%   [N2 F2] = clipConvexPolyhedronPlane(N, F, P);
%   drawPolyhedra(N2, F2);
%
%   See also
%   clipConvexPolygon3dPlane
%
%
% ------
...
for f=1:length(faces)
    ...
    poly = nodes(face, :);
    clipped = clipConvexPolygon3dPlane(poly, plane);
