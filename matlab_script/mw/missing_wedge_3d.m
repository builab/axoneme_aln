function wedge = missing_wedge_3d(vol_size, tiltaxis, neg_tilt, pos_tilt, hsize, sigma)
% MISSING_WEDGE_3D create missing wedge with Gaussian soft edge (Experimental)
%   wedge = missing_wedge_3d(size, tiltaxis, neg_tilt, pos_tilt, hsize, sigma)
%
...
%
% @author HB
% @date 20080804, same as missing_wedge_3dse
