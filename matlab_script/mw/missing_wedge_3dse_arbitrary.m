function wedge = missing_wedge_3dse_arbitrary(vol_size, tiltaxis, neg_tilt, pos_tilt, euler, hsize, sigma)
% MISSING_WEDGE_3DSE_ARBITRARY creates an Gaussian SOFT EDGE arbitrary wedge (EXPERIMENTAL FUNCTION)
%	wedge = missing_wedge_3dse_arbitrary([dimx dimy dimz], tiltaxis, neg_tilt, pos_tilt, [phi theta psi], hsize, sigma)
%
% PARAMETERS
...
%
% Example
%   wedge = missing_wedge_3dse_arbitrary([128 128 128], -95.5, -60, 60, [30 0 0], 3, 1);
%   tom_dspcub(wedge, 0)
%
% @author HB
% @date 26072007
...
if euler(1) == 0 && euler(2) == 0 && euler(3) == 0
    ...
    wedge = missing_wedge_3dse(vol_size, tiltaxis, neg_tilt, pos_tilt, hsize, sigma);
    ...
    wedge_big = missing_wedge_3dse([dim dim dim], tiltaxis, neg_tilt, pos_tilt, hsize, sigma);
