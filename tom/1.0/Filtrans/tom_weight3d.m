...
%
%  tom_weight3d: 
%  weighting function for tomography 
%
%  Syntax:
%  out=tom_weight3d(type,p,fim,psi,num,theta, D)
%
%  Input:
...
%  D                : Specify the thickeness of the Object in pixels  only for exact weighting)
%                      (Uniform sampling in x-y-z is assumed)
%  Output:
