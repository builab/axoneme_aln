function [average, unwei_av] = av3_average_exact(motl, particlefilename,wedgelist,threshold,iclass)
%  AV3_AVERAGE_EXACT averages subtomograms
%   [average, unwei_av] = av3_average_exact(motl, particlefilename,wedgelist,threshold,iclass)
%
