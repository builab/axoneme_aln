function [ccc, covar, xc] = av3_cccmat(motl, particlefilename, wedgelist,mask,hipass,lowpass,iclass,ibin,dispflag)
% AV3_CCCMAT computes correlation- and covariance matrix of particles
%
%   [ccc covar xc] = av3_cccmat(motl, particlefilename, wedgelist,mask,hipass,lowpass,iclass,ibin,dispflag)
%
% PARAMETERS
%  INPUT
%   motl                MOTive List
