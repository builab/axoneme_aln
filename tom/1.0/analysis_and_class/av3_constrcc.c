/*=================================================================
*
* av3_constrcc_c.c    Performs constrained correlation
* The syntax is:
*
*        av3_constrcc_c(ccc,ref,vol,wedge_ref,wedge,PHI,PSI,THETA)
*
*
* 12/28/06 FF
* Last changes: 
...
/* routine correlates reference REF and volume VOL in the overlap of 
   wedge_ref and wedge. VOL and WEDGE are rotated by PHI, PSI, THE*/
