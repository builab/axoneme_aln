...
%
%   A 2D-image I is sampled in polar coordinates RHO, PHI. TOM_POLAR2CART 
%   samples the data on cartesian coordinates using bilinear interpolation.
%   The dimensions of the polar data POL are the radius R and the polar angle
%   PHI. The dimensions are assumed to be (NDIMR, 4*NDIMR). The dimensions of
%   I are (2*NDIMR,2*NDIMR).
%   
