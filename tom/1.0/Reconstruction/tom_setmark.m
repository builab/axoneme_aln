...
%
%   For more information about tom_setmark, see the web page:
%   http://www.biochem.mpg.de/tom/tomography/tom/Reconstruction/tom_setmark.html
%
%   Created: 12/09/02 William Del Net   
%   Last modification: 01/03/05 William Del Net
    ...
    if view_movie>size(param.Matrixmark,3)| view_movie<=0
        ...
        for index=1:size(param.Matrixmark,2)
            ...
            if r1~=-1 & r2~=-1  
                ...
                title(['MOVIE: image n° ' num2str(index)] ,'FontWeight','bold');
