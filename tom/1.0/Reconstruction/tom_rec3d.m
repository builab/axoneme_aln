...
%   Use this routine to make a reconstruction 3D. The user has to make a
%   alignment file before to use this procedure.
%
%   Syntaxe: tom_rec3d
%       Input:
%           -
...
%           - 
%
%   See also: TOM_TILT_LINES, TOM_EMREAD, TOM_EMWRITE, TOM_REC3D   
%       
%   Date: 12/09/02 WDN   
%   Last modified: 14/06/05 WDN
%
%   Copyright (c) 2004
...
set(handles.LowpassFilter,'String','0.25');
EnablePanelRec3d('on');
...
volume = tom_reconstruction3d([handles.Param.PathName handles.Param.FileName],...
    ...
    handles.Param.AbsoluteCenter,ref_image,weightedfile_name,wfo);
