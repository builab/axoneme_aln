...
%
%
%   EXAMPLES (this examples only work if the path tom/data/ is set)
...
%
%   04/17/03 FF
%   04/14/04 FF analytical weighting tested 
%   21/04/04 FB speed up
%   29/06/04 FF fixed bug for offset reconstruction
%   01/04/05 WDN set the name to the weighted file, offset reconstruction
%
%   Copyright (c) 2004
