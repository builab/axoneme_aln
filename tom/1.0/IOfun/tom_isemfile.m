...
if magic(4)==1
    fseek(fid,0,1);
    position=ftell(fid);
    if position~=(xdim.*ydim.*zdim)+512 out=0;end;
elseif magic(4)==2
    fseek(fid,0,1);
    position=ftell(fid);
    if position~=(2.*xdim.*ydim.*zdim)+512 out=0;end;
elseif magic(4)==4
    fseek(fid,0,1);
    position=ftell(fid);
    if position~=(4.*xdim.*ydim.*zdim)+512 out=0;end;
elseif magic(4)==5
    fseek(fid,0,1);
    position=ftell(fid);
    if position~=(4.*xdim.*ydim.*zdim)+512 out=0;end;
elseif magic(4)==8
    fseek(fid,0,1);
    position=ftell(fid);
    if position~=(8.*xdim.*ydim.*zdim)+512 out=0;end;
else
    out=0;
end;
