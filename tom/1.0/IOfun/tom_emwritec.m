...
% TOM_EMWRITEC writes data in EM-file format. C Version under development !
%
...
%       2       COE      µm        1000       Cs of objective lense
...
%                   creates a new file of [1024 2048 512] dimensions in x,
%                   y and z.
%
%               i=tom_emwritec('Volume',out,'subregion',[10 20 30],[63 63 15]);
%                   writes the data with an offset of [10 20 30] to the
%                   file 'Volume'. The last input argument is the size of
%                   the volume subtracted by one.
%
%    See Also
