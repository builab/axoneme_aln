function [Data] = tom_emreadc(em_name,form,nr,nrarea)
...
%
%               i=tom_emread('Vol.em','layer',64);
%                   reads one layer, number 64, of the volume
%
...
[filename, pathname] = uigetfile({'*.em';'*.*'}, 'Pick an EM-file');
...
[Data.Value Data.Header.Magic Data.Header.Size Data.Header.Comment ...
    ...
    Data.Header.FocusIncrement=Data.Header.Parameter(14)./1000;
