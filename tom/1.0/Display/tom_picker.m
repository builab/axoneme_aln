...
%      4         : peak number
%      5         : not occupied - e.g. use for # of tomogram of extracted
%                   particles
...
% Last Modified by GUIDE v2.5 02-Apr-2003 18:02:38
...
guidata(hObject,handles);
handles.motl(10,handles.ind)=handles.slicexy;
m=handles.output;
...
if k==0 %mouse button press
    ...
    handles.motl(9,handles.ind)= pt(1,2);%fixed 07/07/03 FF
    handles.motl(8,handles.ind)= pt(1,1);
