function varargout = tom_intervol2(varargin)
% TOM_INTERVOL(VOLUME) is a tool for interactive visualization of 3D volumes.
...
%   tom_intervol(a);
%
%   See also   TOM_VOLXY, TOM_PARTICLES
%
%   Created: 20/02/03   Friedrich Foerter & William Del Net
%   Last modification: 28/06/04 William Del Net
%
%    Copyright (c) 2004
...
%
% Modified: 19/01/2007 to view better
...
if isstruct(varargin{1})
	...
	handles.Volume.Value = tom_imadj(handles.Volume.Value);
