...
%
%   See also: TOM_EMBROWSE, TOM_EMHEADER, TOM_CTFFIT, IMAGESC
%
%    Copyright (c) 2004
...
%
%   Created: 12/08/02 Stephan Nickell
%   Last modification: 27/02/04 William Del Net
%
...
%    uimenu (menu1,'label','EM file','Callback','A=get(gcf,''Userdata'');if ~isstruct(A); A=A'';A=tom_emheader(A);end;tom_emwrite(A);'); 
    uimenu (menu1,'label','EM file','Callback','A=get(gcf,''Userdata'');tom_emwrite(A);');
else
