...
% TOM_CTFFIT is used to estimate the defocus of an image.
%      
%    Syntaxe: tom_ctffit(Im,Defcocus) 
%       Input (Optional):
%           - Im: Structure of data's picture (Em format)
%           - Defocus: Value estimated of the defocus (in nm). If Defocus is
%                      not set, then the value will be read from the file.
%       Output:
%           - 
%   Example:
%   tom_ctffit
...
%   tom_ctffit(XXX,-4500);
%      
%   See also: TOM_EMREAD, TOM_EMWRITE, TOM_CTFZERO, TOM_PS, IMAGESC   
%
%   Created: 30/04/02 William Del Net   
%   Last modification: 11/07/03 William Del Net
%
%    Copyright (c) 2004
